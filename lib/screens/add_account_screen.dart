...
class _AddAccountScreenState extends State<AddAccountScreen> {
  ...
  void _save() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(content: Text('تم إضافة الحساب: $name بنجاح')),
    );
  }
            ...
            children: [
                ...
                child: Row(
                  children: [
                    CircleAvatar(
                      ...
                      child: const Icon(Icons.account_balance_wallet, color: primaryTeal, size: 28),
                    ),
                  ...
                  child: DropdownButton<String>(
                    ...
                    items: widget.state.categories
                      ...
                      return DropdownMenuItem<String>(
                        ...
                        child: Row(
                          children: [
                            const Icon(Icons.label_outline, color: primaryTeal, size: 18),
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  hintText: 'اسم الحساب',
                  prefixIcon: const Icon(Icons.person_add_alt, color: primaryTeal),
                  filled: true,
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  hintText: 'رقم الهاتف',
                  prefixIcon: const Icon(Icons.phone_outlined, color: primaryTeal),
                  filled: true,
                  fillColor: Colors.white,
                  border: OutlineInputBorder(borderRadius: BorderRadius.circular(14), borderSide: BorderSide.none),
                ),
